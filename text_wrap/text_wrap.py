# import textwrap  # Optional: The 'textwrap' module contains a built-in
# function 'textwrap.fill()' that can perform this task directly.
...
def wrap(string, max_width):
    if 0 < len(string) < 1000 and 0 < max_width < len(string):
        # Using list comprehension to slice the string into chunks of
        # size max_width
