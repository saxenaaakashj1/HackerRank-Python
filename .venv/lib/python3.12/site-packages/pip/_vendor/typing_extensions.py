                ...
                try:
                    ...
                    raise TypeError(
                        f"Failed to determine whether protocol member {
                            attr!r} " "is a method member") from e
                else:
                    if not is_callable:
        ...
        def __new__(cls, name, *, default=NoDefault):
            ...
            def _typevartuple_prepare_subst(alias, args):
                ...
                if var_tuple_index is not None:
                    ...
                    raise TypeError(
                        f"Too few arguments for {alias};" f" actual {alen}, expected at least {
                            plen - 1}")
            ...
            if _is_unpacked_typevartuple(t):
                ...
                if enforce_default_ordering:
                    ...
                    if has_default:
                        ...
                        raise TypeError(
                            f'Type parameter {
                                t!r} without a default' ' follows type parameter with a default')
                        ...
                        try:
                            ...
                            msg = (
                                f"Error calling __set_name__ on {
                                    type(val).__name__!r} " f"instance {
                                    key!r} in {
                                    typename!r}")
