...
def solve(s):
    ...
    # Ensure that the string length is between 1 and 999 characters and matches the regex pattern
    if 0 < len(s) < 1000 and matches:
        # Split the string into words, capitalize each word's first letter,
